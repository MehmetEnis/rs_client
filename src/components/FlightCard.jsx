...
export default function FlightCard({ journey, onSelect }) {
  ...
  return (
    <div
      className="card p-4 hover:shadow-md transition-shadow cursor-pointer hover:border-brand-300"
      onClick={onSelect}
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 text-sm">
            ...
            <div className="flex-1 flex flex-col items-center gap-0.5">
              <p className="text-xs text-gray-400">{journey.totalDuration}</p>
        ...
        <div className="text-right shrink-0">
          ...
          {price === 0 && (
            <p className="text-xs text-gray-400 italic">Included in RT</p>
          )}
        </div>
      </div>
